    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result1 = _a.sent();
                    return [4 /*yield*/, Promise.all([previousWithDelay(2000), previousWithDelay(2500), previousWithDelay(3000)]).then(function (result) {
                            console.group("Task2");
                            console.log(result);
                            console.groupEnd();
                        })];
                ...
                case 3:
                    ...
                    return [4 /*yield*/, prm.then(function (result) {
                            ...
                            if (typeof (result) == 'number') {
                                return new Promise(function (resolve, reject) { return setTimeout(function () { return resolve(result * 2); }, 1000); });
                            }
